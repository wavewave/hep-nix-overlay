...
, libtiff, libjpeg, giflib, libpng, pcre, freetype, python, libxml2
...
stdenv.mkDerivation { 
  ...
  buildInputs = [ cmake gfortran zlib libX11 libXext libXpm libXft pcre freetype 
                  giflib libtiff libjpeg libpng python gsl krb5 libxml2 openssl
...
'';
  cmakeFlags = "-Dopengl:String=OFF -Dpythia8:String=OFF -Dpythia6:String=OFF -Dpgsql:String=OFF -Dgviz=OFF";   
